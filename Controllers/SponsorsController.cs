...
namespace MyTournaments.Controllers
{
    public class SponsorsController : Controller
    {
        ...
        public SponsorsController(DBTournamentsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Info")] Sponsor sponsor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Info")] Sponsor sponsor)
        {
            if (id != sponsor.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            var tourn = from t in _context.Tournament
                        where t.SponsorId == id
                        select t;
